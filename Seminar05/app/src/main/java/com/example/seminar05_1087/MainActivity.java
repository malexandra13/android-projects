...
//        });
        ...
        //pentru deschiderea unei noi activitati (MainActivity2)
        //se adauga in metoda onCreate
    ...
    //Popularea activitatii principale cu info din activitate secundara
    //NU se adauga in metoda onCreate
    @Override
    ...
    private void seteazaAdapterLista(){
        ...
        adapter = new ArrayAdapter<Curs>(getApplicationContext(),
                android.R.layout.simple_list_item_1,listaCursuri);
        ListView lv = findViewById(R.id.listView);
